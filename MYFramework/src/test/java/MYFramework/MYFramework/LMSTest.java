...
public class LMSTest {
	...
	public static void main(String[] args) throws Exception  {
		...
		for(int i=2;i<reader.getRowCount("LMSData");i++){
			...
			WebElement LearningAdministration=driver.findElement(By.xpath("//h3[text()='Learning Administration']//ancestor::div[2]"));
			...
			/*while(TestUtil.iselementExists(driver.findElement(By.xpath("//div[contains(@id,'shim')]")))) {
			 ...
			 // waitForLoad(driver);
			  Thread.sleep(30000);
			//TestUtil.VisibleOn(driver, driver.findElement(By.xpath("//div[text()='Manage User Learning']//ancestor::li//span")), 80);
			...
			driver.findElement(By.name("assignmentProfileId")).sendKeys(assignmentprofile+"_"+i+"."+k);
			...
			String Libraries = reader.getCellData("LMSData", "Libraries", i);
			String[] Libraryname=Libraries.split(";");
			String Librarynamenew = Libraryname [0];
			Thread.sleep(3000);
			WebElement iframe3 = driver.findElement(By.xpath("//iframe[contains(@name,'PPCFrame')][1]"));
			driver.switchTo().frame(iframe3);
			Thread.sleep(2000);
			driver.findElement(By.xpath("//input[@name='FULL_TEXT_SEARCH']")).sendKeys(Librarynamenew);
			Thread.sleep(2000);
			...
			List<WebElement>LibraryTable = driver.findElements(By.xpath("//table[@class='ResultsTable'][1]//tr//td"));
			for(int j=0;j<LibraryTable.size();j++){
				if(LibraryTable.get(j).getText().contains("COM_TEST"))
				{
					Thread.sleep(1000);
			...
			Thread.sleep(5000);
			String SecurityDomains = reader.getCellData("LMSData", "Security Domains", i);
			...
			String SecurityDomainrule = SecurityDomainsname [0].trim();;			
